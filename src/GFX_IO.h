...
/*!
  @brief  GFX_IO is an intermediary class between GFX_Root
...
public:
  ...
  GFX_IO(uint16_t w, uint16_t h, int16_t cs, int16_t dc, int16_t mosi,
  ...
  GFX_IO(uint16_t w, uint16_t h, int16_t cs, int16_t dc,
                  int16_t rst = -1);
  ...
  GFX_IO(uint16_t w, uint16_t h, SPIClass *spiClass, int16_t cs,
  ...
  GFX_IO(uint16_t w, uint16_t h, tftBusWidth busWidth, int16_t d0,
  ...
  */
  ...
  using GFX_Root::drawRGBBitmap; // Check base class first
  ...
  // GFX_IO_Macros.h. Some have been made into inline functions
