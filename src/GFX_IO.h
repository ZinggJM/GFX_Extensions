...
public:
  ...
  GFX_IO(uint16_t w, uint16_t h, int8_t cs, int8_t dc, int8_t mosi,
  ...
  GFX_IO(uint16_t w, uint16_t h, int8_t cs, int8_t dc,
                  int8_t rst = -1);
  ...
  GFX_IO(uint16_t w, uint16_t h, SPIClass *spiClass, int8_t cs,
  ...
  GFX_IO(uint16_t w, uint16_t h, tftBusWidth busWidth, int8_t d0,
